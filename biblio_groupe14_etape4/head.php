...
<body>
<div class="bd">
	<div class="bd_texture"></div>libra
	<div class="bd_mask">
	...
	<div class="container">
		...
		<div class="header__navbar--logo-menu">
			...
			<a href="" class="bd_navbar-menu-link"><i class="fas fa-book"></i></i>Livres</a>
			<a href="contact.php" class="bd_navbar-menu-link"><i class="fas fa-phone"></i>Contact</a>
		    </div>
	    </div>
	    <div class="bd_slogan">
